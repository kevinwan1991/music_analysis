					...
					<tr>
						...
						<td width="20%" height="30" valign="top">
						  	<form action="info_singer">
						  		<input type = "text" name = "singerName" onkeyup="showAjax()" id="showAjaxText" style="height:20px;background:scroll 0 0 #FFFFFF;"/>
						  		<input type = "submit" value = "search"/>	
						  		<br/>
      							<div id="showAjaxId" style="height:100px;display:none; overflow-y:auto;overflow-x:hidden;"> </div>
						  	</form>
						</td>
					</tr>
					<tr>
